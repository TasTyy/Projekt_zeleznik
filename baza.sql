...
Create table Ocene (
	...
	id_u Int NOT NULL,
	id_d Int NOT NULL,
 Primary Key (id_o)) ENGINE = MyISAM;
...
Alter table Ocene add Foreign Key (id_u) references Uporabniki (id_u) on delete  restrict on update  restrict;
Alter table Komentarji add Foreign Key (id_d) references Darila (id_d) on delete  restrict on update  restrict;
Alter table Ocene add Foreign Key (id_d) references Darila (id_d) on delete  restrict on update  restrict;
